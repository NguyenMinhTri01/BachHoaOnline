...
$(document).ready(function () {
  ...
  var moremanu = $(".moremanu");
  var brandListMore = $('.brandListMore');
  var brandItem = $('.brandItem');


  brandItem.click(function(event) {
    $('.activeBrand').attr('class', '');
    var parent = $(this).parent();
    parent.attr('class', 'activeBrand');
  ...
  moremanu.click(function (e) {
    var status = $(this).attr('data-status');
    if (status === '1'){
      brandListMore.css('display', 'block');
      $(this).html('Rút gọn <i class="fatm fatmShow"></i>');
      $(this).attr('data-status', '-1');
    }else {
      brandListMore.css('display', 'none');
      $(this).html('Xem Thêm <i class="fatm"></i>');
      $(this).attr('data-status', '1');
    }
  })
